...
modo.addEventListener ("click", function(){
    if (modo.className.includes("fa-sun")){
        ...
        document.documentElement.style.setProperty('--color-1', 'grey');
        document.documentElement.style.setProperty('--color-2', 'grey');
        document.documentElement.style.setProperty('--color-3', 'grey');
        document.documentElement.style.setProperty('--color-pagina', 'darkgrey');
        ...
        document.documentElement.style.setProperty('--color-1', 'rgb(113, 113, 236)');
        document.documentElement.style.setProperty('--color-2', 'rgb(126, 126, 245)9');
        document.documentElement.style.setProperty('--color-3', '#9584fa');
